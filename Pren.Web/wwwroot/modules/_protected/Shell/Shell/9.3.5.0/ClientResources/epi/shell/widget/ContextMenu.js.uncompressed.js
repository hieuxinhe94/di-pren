define("epi/shell/widget/ContextMenu", [
    ...
    return ContextMenu = declare([Menu, _CommandConsumerMixin], {
        ...
        postCreate: function () {
            ...
            configuration = [defaultConfiguration, { builder: new MenuWithSeparatorBuilder(), target: this, category: "menuWithSeparator" }, { builder: new MenuBuilder(), target: this, category: "popup" }],
