   ...
   postMessage
        ...
        return declare([_WidgetBase, _Container, _TemplatedMixin], {
            ...
            addChild: function (/*dijit._Widget*/widget, /*int?*/insertIndex) {
                ...
                if (widget.onResize) {
                    handles.push(this.connect(widget, "onResize", this._onContentChange));
                }

                this._childConnects[widget.id] = handles;
            },
            ...
            removeChild: function (widget) {
                ...
                var handles = this._childConnects[widget.id];

                this._childConnects[widget.id] = null;
                delete this._childConnects[widget.id];
