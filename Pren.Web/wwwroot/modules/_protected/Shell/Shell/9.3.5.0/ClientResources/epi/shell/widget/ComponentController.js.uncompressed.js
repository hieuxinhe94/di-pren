    ...
    return declare([_WidgetBase], {
        ...
        _runSaveComponentRequest: function (/* Boolean */ forceRun) {
            ...
            if (forceRun || !this._isSaveComponentRequestInProgress) {
                ...
                if (runIt) {
                    this._componentsStore.put(runIt.item).then(function (result) {
                        // resolve the promise here
                        if (runIt.promise != null) {
        ...
        saveComponent: function (/* Object */component) {
            // summary:
            //      Save a component (but not any child components)
            //
            // component:
            //      The component
            //
            ...
            // create a deffered and return it, in the meanwhile push the request to queue and start the queue run process
            this._saveComponentRequestQueue.push({ "item": simpleComponent, "promise": future });
        ...
        sortComponents: function (/* dijit._Widget */container, /* Object[] */components, /* Function */callback) {
            ...
            //
            // components:
            //      List of compontents (id and column)
            //
            // callback:
            ...
            if (items instanceof Array && items.length > 0) {
                ...
                if (items[0] instanceof Array) {
                    ...
                    for (var i = 0; i < items.length; i++) {
                        ...
                        deferreds.push(factory.createWidgets(nodes[i], componentsDefinition));
                    }
