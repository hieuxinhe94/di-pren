...
// dojo
    ...
    return {
        ...
        stripHtmlTags: function (/*String*/input) {
            ...
            var dom = domConstruct.toDom(input.replace(/&/gim, "&amp;"));
            return this.removeAllCarriageReturns(dom.textContent || dom.innerText);
        },
        ...
        encodeForWebString: function (/*String*/input, /*Array*/uiSafeHtmlTags) {
            ...
            if (uiSafeHtmlTags == null || uiSafeHtmlTags.length === 0) {
                return safeString;
            }
