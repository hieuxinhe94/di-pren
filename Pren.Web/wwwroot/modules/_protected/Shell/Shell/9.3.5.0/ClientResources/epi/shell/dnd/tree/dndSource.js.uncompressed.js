define("epi/shell/dnd/tree/dndSource", [
    ...
    return declare([dndSource, _DndDataMixin], {
        ...
        deleteSelectedNodes: function () {
            // Method needed to interact with other sources but should not do anyting
        },
        ...
        onDndDrop: function (source, nodes, copy, target) {
            ...
            if (source !== target && !copy && source.onDndItemRemoved) {
        ...
        _onDragMouse: function (e, firstTime) {
            ...
            if (m.canDropFlag) {
                when(this.checkItemAcceptance(this.current.rowNode, m.source, null), function (accepted) {
                    m.canDrop(accepted);
                });
            }
