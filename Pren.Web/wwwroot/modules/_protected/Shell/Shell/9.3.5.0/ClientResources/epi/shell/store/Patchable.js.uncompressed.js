define("epi/shell/store/Patchable", [
    ...
    "dojo/when"
], function (lang, Deferred, all, Cache, Observable, when) {
    ...
    return function (masterStore, cachingStore, /*dojo.store.__CacheArgs*/options) {
        ...
        var updateId = function (object, result) {
            ...
            if (typeof result == "object") {
                object[store.idProperty] = result[store.idProperty];
            } else {
                object[store.idProperty] = result;
            }
        };
        ...
        var _mixin = function (dest, source) {
            ...
            //            whereas dojo.mixin overwirites sub-properties in dest.
        ...
        var store = lang.delegate(Observable(cache), {
