    ...
    return declare([_DateTimeTextBox], {
        ...
        _onBlur: function () {
            ...
            if (this._dropDownShowing) {
                ...
                // If user enter manually an invalid value then reset it to default value
                // We don't set default value if user don't want to input date information
                if (this.dropDown && !this.get("value") && this.get("value") !== null) {
                    this.set("value", this.dropDown.get("value"));
                }
            }
