...
﻿define("epi/dependency", ["dojo", "epi"], function (dojo, epi) {

    var Dependency = dojo.declare("epi._Dependency", null, {
        // tags:
        //      public
...
﻿define("epi/epi", [
    ...
    epi.areEqual = function (first, second) {
        ...
        if ((first === second) || (first == second) || (typeof first == "number" && typeof second == "number" && isNaN(first) && isNaN(second))) {
            return true;
        }
