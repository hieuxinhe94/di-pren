...
res) {
    ...
    return dojo.declare(ScrollingTabController, {
        // summary:
        ...
        onAddChild: function (/*dijit._Widget*/page, /*Integer?*/insertIndex) {
            ...
            this.connect(page.controlButton, 'onClick', dojo.hitch(this, "onButtonClick", page));
            this.connect(page.controlButton, 'onClickCloseButton', dojo.hitch(this, "onCloseButtonClick", page));
            this.connect(page.controlButton, 'onCloseMenuItem', dojo.hitch(this, "onCloseButtonClick", page));
            this.connect(page.controlButton, 'onLayoutClick', dojo.hitch(this, "onLayoutChanged", page));
            this.connect(page.controlButton, 'onTabTitleChanged', dojo.hitch(this, "onTabTitleChanged", page));
        ...
        _initButtons: function () {
            ...
            dojo.style(this._addBtn.domNode, "display", this.useAddMenu ? "" : "none");
        },
        ...
        resize: function (/*Object*/dim) {
            ...
            dijit.layout.layoutChildren(this.domNode, this._contentBox, [this._addBtn, this._menuBtn, this._leftBtn, this._rightBtn, { domNode: this.scrollNode, layoutAlign: "client"}]);
