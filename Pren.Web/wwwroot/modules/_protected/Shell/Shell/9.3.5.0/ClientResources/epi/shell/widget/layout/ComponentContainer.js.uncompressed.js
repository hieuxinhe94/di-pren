define("epi/shell/widget/layout/ComponentContainer", [
    ...
    return declare([GridContainer, _ActionProvider], {
        ...
        _persistComponentSettings: function () {
            ...
            var allChildern = this.getChildren();
            array.forEach(allChildern, function (component) {
                // Update the settings by mixing the current settings onto the persisted settings.
                ...
                this._componentsController.saveComponent(componentDef);
            }, this);
        },
