...
{
    public class CodePortalOfferBlockController : BlockController<CodePortalOfferBlock>
    {
        ...
        public CodePortalOfferBlockController(
        ...
        public override ActionResult Index(CodePortalOfferBlock currentBlock)
        {
            var model = new CodePortalOfferBlockViewModel(currentBlock);
