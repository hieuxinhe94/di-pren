<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EventSearch.aspx.cs" Inherits="Pren.Web.Tools.Admin.EventSearch.EventSearch" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="MainBodyArea">
            ...
            <asp:ObjectDataSource runat="server" ID="GvDataSource" TypeName="Pren.Web.Tools.Admin.EventSearch.EventSearch" SelectMethod="GetResult">
                <SelectParameters>
