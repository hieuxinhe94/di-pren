...
namespace Pren.Web.Tools.Admin.ExtraInfoSearch
{
    [GuiPlugIn(Area = PlugInArea.AdminMenu, Description = "Sök extra info fält", RequiredAccess = EPiServer.Security.AccessLevel.Administer, DisplayName = "Extrainfosök", UrlFromUi = "/Tools/Admin/ExtraInfoSearch/ExtraInfoSearch.aspx", SortIndex = 1050)]
    public partial class ExtraInfoSearch : System.Web.UI.Page
    {
        ...
        public DataSet GetResult(string fromdate)
        {
            ...
            //Return result
            return SqlHelper.ExecuteDatasetParam("PrenWebMisc", "ExtraInfoSearch", sqlParamList.ToArray());
        }
    }
}