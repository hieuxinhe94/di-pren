<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExtraInfoSearch.aspx.cs" Inherits="Pren.Web.Tools.Admin.ExtraInfoSearch.ExtraInfoSearch" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="MainBodyArea">
            ...
            <asp:ObjectDataSource runat="server" ID="GvDataSource" TypeName="Pren.Web.Tools.Admin.ExtraInfoSearch.ExtraInfoSearch" SelectMethod="GetResult">
                <SelectParameters>
