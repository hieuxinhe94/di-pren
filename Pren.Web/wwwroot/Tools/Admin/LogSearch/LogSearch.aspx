<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogSearch.aspx.cs" Inherits="Pren.Web.Tools.Admin.LogSearch.LogSearch" %>
...
<asp:content contentplaceholderid="FullRegion" runat="Server">
    ...
    <style type="text/css">
        ...
        table td:nth-child(3),table td:nth-child(4),table td:nth-child(5){ width: 30%; word-wrap: break-word;max-width: 300px;}
        table td:nth-child(6){ width: 50px;}
    ...
    <div class="epi-contentContainer epi-padding">
        ...
        <div class="epi-contentArea">
            ...
            <div class="clear">                                            
                ...
                <asp:Label runat="server" AssociatedControlID="TxtException"><strong>Felmeddelande:</strong></asp:Label><br/>
                <asp:TextBox runat="server" ID="TxtException"></asp:TextBox><br/><br/>
                ...
                <asp:GridView runat="server" AllowSorting="false" DataSourceID="GvDataSource" ID="GvResult" AutoGenerateColumns="False">
                    <Columns>
                        <asp:TemplateField >                        
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Felmeddelande">                        
                            <ItemTemplate>
                                <%# Eval("exception")%>
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <asp:ObjectDataSource runat="server" ID="GvDataSource" TypeName="Pren.Web.Tools.Admin.LogSearch.LogSearch" SelectMethod="GetResult">
                <SelectParameters>
                    ...
                    <asp:ControlParameter ControlID="TxtException" Name="exception" PropertyName="Text" />
                </SelectParameters>       
