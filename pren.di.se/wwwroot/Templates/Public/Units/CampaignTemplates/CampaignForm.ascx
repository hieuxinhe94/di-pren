<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="CampaignForm.ascx.cs" Inherits="PrenDiSe.Templates.Public.Units.CampaignTemplates.CampaignForm" %>
...
<script type="text/javascript">
    ...
    function showHideCompanyCoBySetting() {
      $('div[data-company-co="show"]').show();
      $('div[data-company-co="hide"]').hide();
    }
    
    function HideAddressCompanyCoCheck() {
      if (!$('input[value="RbInvoice"]').is(':checked')) {
        $('.address').hide();
        $('div[data-company-co]').hide();
      } else {
        $('div[data-company-co]').show();
      }
    }

    // Called onLoad and on radiobuttons click in FormHandler()!
    function VerifyAddressFieldsVisibility() {
      showHideCompanyCoBySetting();
      HideAddressCompanyCoCheck();
    }
</script>
...
<div class="campaignform <%#ValidationGroup %>">
    ...
    <div runat="server" DefaultButton="BtnSubmitForm">
        ...
        <div class="control-row borderbottom">
            <div class="control-group validateinput">
                <asp:Label CssClass="control-label" runat="server" AssociatedControlID="TxtFirstName">
                    Förnamn                                                    
                    <asp:RequiredFieldValidator id="rfvFirstName" runat="server" CssClass="val" ValidationGroup="<%#ValidationGroup %>" ControlToValidate="TxtFirstName" ErrorMessage="Du måste ange förnamn"><span class="status">&nbsp;</span></asp:RequiredFieldValidator>                                                                                                        
                </asp:Label>
                <div class="controls">
            ...
            <div class="control-group validateinput">
                <asp:Label CssClass="control-label" runat="server" AssociatedControlID="TxtLastName">
                    Efternamn
                    <asp:RequiredFieldValidator ID="rfvLastName" runat="server" CssClass="val" ValidationGroup="<%#ValidationGroup %>" ControlToValidate="TxtLastName" ErrorMessage="Du måste ange efternamn"><span class="status">&nbsp;</span></asp:RequiredFieldValidator>
                </asp:Label>
                <div class="controls">
        ...
        <asp:PlaceHolder runat="server" Visible="<%#!IsOtherPayerForm %>">
            <div class="control-group validateinput">
                <asp:Label CssClass="control-label" runat="server" AssociatedControlID="TxtEmail">
                    ...
                    <asp:RequiredFieldValidator ID="rfvEmail" runat="server" CssClass="val" ValidationGroup="<%#ValidationGroup %>" ControlToValidate="TxtEmail" ErrorMessage="Du måste ange e-postadress"><span class="status">&nbsp;</span></asp:RequiredFieldValidator>
    ...
    <div class="control-row" data-company-co="<%= CompanyCoBothHidden ? "hide" : "show" %>">
        <asp:PlaceHolder ID="phCompany" runat="server" Visible="<%# ShowCompany %>">
            <div class="control-group">
        ...
        <div class='<%= ShowAdressFields ? "control-group address" : "control-group address hidden" %>'>
    ...
    <asp:Panel ID="panAddressContainer" CssClass='<%# ShowAdressFields ? "address" : "address hidden" %>' runat="server">
        ...
        <div class="control-row">
            ...
            <div class='control-group validateinput'>
                <asp:Label runat="server" AssociatedControlID="TxtStreetAddress">
                    Gatuadress
                    <%--Disable validation --%>
                    <asp:RequiredFieldValidator runat="server" ID="ReqValStreetAddress" CssClass="val" ValidationGroup="<%#ValidationGroup %>" ControlToValidate="TxtStreetAddress" ErrorMessage="Du måste ange gatuadress"><span class="status">&nbsp;</span></asp:RequiredFieldValidator>
                </asp:Label>
                <div class="controls">
        ...
        <div class="control-row">
            ...
            <div class="control-group">
              <asp:Label AssociatedControlID="TxtCity" runat="server">
                Ort
              </asp:Label>
              <div class="controls">
                <asp:TextBox ID="TxtCity" CssClass="input-large" runat="server"></asp:TextBox>
              </div>
    ...
    <asp:PlaceHolder runat="server" Visible="<%# !IsOtherPayerForm %>">
        ...
        <div class="control-row">
            <div class="control-group validateinput">                
                <div class="controls">
                    <input type="checkbox" id="ChkTerms" runat="server" class="chkTerms" /> <span>Jag godkänner <asp:HyperLink ID="lnkTermsConditions" Text="prenumerationsvillkoren" Target="_blank" runat="server"></asp:HyperLink> och samtycker till däri beskriven personuppgiftsbehandling inom Bonnierkoncernen</span>
    ...
    <asp:PlaceHolder ID="phPaymentContainer" runat="server" Visible='<%# ShowPaymentFields %>'>
    ...
    <asp:Button runat="server" ID="BtnBack" OnClick="BtnBackOnClick" CssClass="btn btn-large"  data-loading-text="Laddar steg" />
