(function ($) {
    ...
    var AjaxHandler = {
        saveEmailAddress: function (email) {
            $.ajax({
                type: "POST",
                url: "http://" + document.domain + "/Templates/Public/Pages/CampaignTemplates/CampaignPaperPrototyp/GetJson.ashx?action=email&email=" + email,
                timeout: 20000,
                dataType: "text",
        ...
        populateParData: function (ssn) {
            $.ajax({
                type: "POST",
                url: "http://" + document.domain + "/Templates/Public/Pages/CampaignTemplates/CampaignPaperPrototyp/GetJson.ashx?pno=" + ssn + "&pageId=" + CampaignHandler.constants.pageId + "&campaign=" + CampaignHandler.getSelectedCampaign(),
                timeout: 20000,
                dataType: "text",
                success: function (msg) {
        ...
        setPostalCity: function (zip, suffix) {
            ...
            $.ajax({
                type: "POST",
                url: "http://" + document.domain + "/Templates/Public/Pages/CampaignTemplates/CampaignPaperPrototyp/GetJson.ashx?action=zip&zip=" + zip,
                timeout: 20000,
                dataType: "text",
                success: function (msg) {
