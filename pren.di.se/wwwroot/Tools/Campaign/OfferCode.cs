...
////using EPiServer.Utility.Campaign;
...
//            DataSet dsCampaign = CirixDbHandler.GetCampaign(long.Parse(row["campNo"].ToString()));
...
//                {
//                    if (DiscPercent > 0)
//                        returnValue = Math.Round(returnValue * ((100 - DiscPercent) * 0.01));
//                }
...
//                if (TotalPrice > 0)
//                    returnValue = Math.Round(TotalPrice * 1.06);
...
//                if (IsAutogiro)
//                    returnValue = Math.Round(TotalPrice / SubsLength);
