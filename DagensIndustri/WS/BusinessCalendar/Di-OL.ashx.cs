...
namespace WS.BusinessCalendar
{
    ...
    public class BusinessCalendar : IHttpHandler
    {
        ...
        private string PrintCalendar(string id)
        {
            ...
            try   { g = new Guid(id); }
            catch { return PrintCalendarError(id); }
            ...
            try
            {
                ...
                {
                    //log INFO
                    new Logger("PrintCalendar() - success - cusno: " + sub.Cusno);
            ...
            {
                new Logger("PrintCalendar() - failed - id: " + id, ex.ToString());
            }

            return PrintCalendarError(id);
        }


        private string PrintCalendarError(string id)
        {
            //log INFO
            new Logger("PrintCalendarError() - failed - id: " + id);
