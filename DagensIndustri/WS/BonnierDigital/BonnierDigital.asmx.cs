...
namespace WS.BonnierDigital
{
    ...
    public class BonnierDigital : System.Web.Services.WebService
    {
        ...
        //    return SubscriptionController.GetUpdatedCusnosInDateInterval(min, max);
        //}
        ...
        //    SubscriptionController.FlagCustsInExpCustomer(cusnos, "Y");
        //}
    }
    ...
    //    {
    //        var custs = new List<PlusCustomer>();
    //        try
    //        {
    ...
    //                    {
    //                        var isActivePlusSubscriber = true;
    //                        var dateSubsStart = DbHelpMethods.SetDateFromDbFieldName(dr, "SUBSSTARTDATE");
    //                        var dateSubsEnd = DbHelpMethods.SetDateFromDbFieldName(dr, "SUBSENDDATE");
    //                        var susp = DbHelpMethods.SetDateFromDbFieldName(dr, "SUSPENDDATE");
    ...
    //                        custs.Add(new PlusCustomer(CustomerId, true, isActivePlusSubscriber, dateSubsStart, dateSubsEnd));
    //                    }
    //                }
    //            }
    //        }
