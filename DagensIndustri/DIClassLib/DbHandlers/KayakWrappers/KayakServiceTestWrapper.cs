...
{
    public class KayakServiceTestWrapper : KayakTest.KayakWebServiceSoapClient, IKayak
    {
            ...
            string sOrderId, string sPaperCode, string sReferenceno)
        {
            ...
            return this.FindCustomers_CII(lCusno, lInvno, lSubsno, sName1, sName2, sName3, sPhone, sSocialsecno, sEmail,
                sStreet, sHouseNo, sStaircase, floor, sApartment, sCountry, sZipcode, sUserid, sPostname, sOtherCusno,
