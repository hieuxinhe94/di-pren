    ...
    public class ServiceVerifier
    {
        ...
        public static bool ApsisIsValid
        {
            get
            {
                ...
                {
                    ServiceVerifierStatus status = VerifyApsis(true);
        ...
        public static ServiceVerifierStatus VerifyApsis(bool useAspisVersion3)
        {
            ServiceVerifierStatus status = new ServiceVerifierStatus();
            ...
            try
            {
                if (useAspisVersion3)
                {
                    ApsisNewsletterProv3APISoapClient _wsV3 = new ApsisNewsletterProv3APISoapClient();
                    DataSet dsBounces = _wsV3.GetTransactionBouncesByDateInterval(_apsisUser, _apsisPass, MiscFunctions.GetAppsettingsValue("apsisProjectGuid2013_paperLong"), dtStart.ToString(), dtEnd.ToString());
                    status.IsValid = true;
                }
                else
                {
                    ApsisNewsletterProAPISoapClient _ws = new ApsisNewsletterProAPISoapClient();
                    TransactionBounceResult[] bounces = _ws.GetTransactionBouncesByDateInterval(_apsisUser, _apsisPass, MiscFunctions.GetAppsettingsValue("apsisProjectGuid2013_paperLong"), dtStart, dtEnd);
                    status.IsValid = true;
                }
            }
            catch (Exception ex)
