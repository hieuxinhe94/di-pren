...
namespace CSSFriendly
{
    ...
    //    <div style="margin-left:20px; padding-bottom:20px; height:30px;">
    //    <asp:Menu ID="MySettingsMenu1" Orientation="Horizontal" onmenuitemclick="MySettingsMenu_OnClick" CssSelectorClass="SimpleEntertainmentMenu" runat="server">
    //        <Items>
    //            <asp:MenuItem Text="Kund" Selectable="false">
    //                <asp:MenuItem Text="Personuppgifter"></asp:MenuItem>
    //                <asp:MenuItem Text="Inloggningsuppgifter"></asp:MenuItem>
    //                <asp:MenuItem Text="Permanent adress"></asp:MenuItem>
    //            </asp:MenuItem>
    //            <asp:MenuItem Text="Prenumeration" Selectable="false">
    //                <asp:MenuItem Text="Di 6-dagars" Selectable="false">
    //                    <asp:MenuItem Text="Tillfällig adressändring"></asp:MenuItem>
    //                    <asp:MenuItem Text="Uppehåll"></asp:MenuItem>
    //                    <asp:MenuItem Text="Faktura"></asp:MenuItem>
    //                </asp:MenuItem>
    //                <asp:MenuItem Text="Di+" Selectable="false">
    //                    <asp:MenuItem Text="Faktura"></asp:MenuItem>
    //                    <asp:MenuItem Text="Avsluta prenumeration"></asp:MenuItem>
    //                </asp:MenuItem>
    //                <asp:MenuItem Text="Vintips via SMS"></asp:MenuItem>
    //            </asp:MenuItem>
    //            <asp:MenuItem Text="Di Guld medlemskap"></asp:MenuItem>
    //        </Items>
    //    </asp:Menu>
    //</div>
