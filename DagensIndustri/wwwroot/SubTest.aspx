...
<td valign="top" width="420">
    ...
    * Email: <asp:TextBox ID="TextBoxSubEmail" runat="server"></asp:TextBox><br/>
    ...
    Stairs: <asp:TextBox ID="TextBoxSubStairs" runat="server"></asp:TextBox><br/>
    ApartmentNo: <asp:TextBox ID="TextBoxSubApartmentNo" runat="server"></asp:TextBox><br/>
    ...
    Staircase: <asp:TextBox ID="TextBoxPayStairCase" runat="server"></asp:TextBox><br/>
    Stairs: <asp:TextBox ID="TextBoxPayStairs" runat="server"></asp:TextBox><br/>
    ApartmentNo: <asp:TextBox ID="TextBoxPayApartmentNo" runat="server"></asp:TextBox><br/>
