            ...
            <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td valign="top" style="display:none;">
                        ...
                        <td><asp:Button ID="ButtonSyncByCusno" runat="server" Text="Synka från prensystemet" onclick="ButtonSyncByCusno_Click" /></td>
                        </tr>
                        </table>
                                ...
                                <ItemTemplate>
                                        <tr class='<%# Container.ItemIndex % 2 == 0 ? "evenrow" : "oddrow" %>'>
                                            ...
                                            <td>
                                                ...
                                                <asp:LinkButton runat="server" ID="LbUnlock" OnClick="LbUnlockOnClick" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "cusno") %>' CssClass="unlock" OnClientClick="javascript:return confirm('Är du säker på att du synkronisera kund?');" Text="Synka från prensystemet"></asp:LinkButton>
                                            </td>
                    ...
                    <td valign="top" style="display:none;">
                        ...
                        <table border="0" cellpadding="0" cellspacing="3">
                            <tr>
                                <td colspan="3"><asp:CheckBox runat="server" ID="ChkNewMyPage" Text="Kod för nya min sida" Checked="False"/> </td>
                            </tr>
                        <tr>
                        <td>Kundnummer</td>
