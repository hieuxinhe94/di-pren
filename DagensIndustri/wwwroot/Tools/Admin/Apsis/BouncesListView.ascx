...
<%@ Import Namespace="DIClassLib.DbHandlers" %>
...
runat="server">
    ...
    <ItemTemplate>
        ...
        <td><asp:CheckBox ID="CheckBoxRegularLetter" 
            EnableViewState="false" 
            Enabled="<%# SubscriptionController.ActiveHandler == SubscriptionController.AvailableHandlers.Cirix %>" runat="server" /> 
            <asp:Literal ID="litRegLetterInfo" Visible="<%# SubscriptionController.ActiveHandler == SubscriptionController.AvailableHandlers.Kayak %>" runat="server">
                &lt;= <i>Ej implementerat för Kayak!</i>
            </asp:Literal> </td>
        </tr>
