...
namespace DagensIndustri.Tools.Admin.InfoSearch
{
    ...
    public partial class InfoSearch : System.Web.UI.Page
    {
        ...
        /// </summary>
        public DataSet GetResult(string fromdate, string info)
        {
            ...
            sqlParamList.Add(new SqlParameter("@info", info.Replace("*", "%")));

            //Return result
            return SqlHelper.ExecuteDatasetParam("DagensIndustriMISC", "LogSearchInfo", sqlParamList.ToArray());
        }
    }
}