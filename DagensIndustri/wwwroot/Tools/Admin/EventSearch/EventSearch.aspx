<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EventSearch.aspx.cs" Inherits="DagensIndustri.Tools.Admin.EventSearch.EventSearch" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="MainBodyArea">
            ...
            <asp:ObjectDataSource runat="server" ID="GvDataSource" TypeName="DagensIndustri.Tools.Admin.EventSearch.EventSearch" SelectMethod="GetResult">
                <SelectParameters>
