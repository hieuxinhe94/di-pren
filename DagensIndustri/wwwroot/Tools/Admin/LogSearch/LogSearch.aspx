<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogSearch.aspx.cs" Inherits="DagensIndustri.Tools.Admin.LogSearch.LogSearch" %>
        ...
        <div id="MainBodyArea">
            ...
            <tr>
                <td>
                    ...
                    <asp:TextBox runat="server" Width="150" ID="TxtDescription"></asp:TextBox>
                </td>
            </tr>
            ...
            <asp:ObjectDataSource runat="server" ID="GvDataSource" TypeName="DagensIndustri.Tools.Admin.LogSearch.LogSearch" SelectMethod="GetResult">
                <SelectParameters>
