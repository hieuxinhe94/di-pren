...
namespace DagensIndustri.Tools.Admin.MailSearch
{
    ...
    public partial class MailSearch : System.Web.UI.Page
    {
        ...
        /// </summary>
        public DataSet GetResult(string fromdate, string subject, string body)
        {
            ...
            sqlParamList.Add(new SqlParameter("@subject", subject.Replace("*", "%")));
            sqlParamList.Add(new SqlParameter("@body", body.Replace("*", "%")));

            //Return result
            return SqlHelper.ExecuteDatasetParam("DagensIndustriMISC", "LogSearchEmail", sqlParamList.ToArray());
        }
    }
}