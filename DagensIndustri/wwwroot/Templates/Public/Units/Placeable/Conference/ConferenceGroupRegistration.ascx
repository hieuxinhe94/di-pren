       ...
       <div class="row">
        ...
        <div class="button-wrapper">
            ...
            <div style="float:right;">
                <asp:Button ID="ConferenceGroupRegistrationButton" Text='Skicka anmälan' CssClass="btn" OnClick="ConferenceGroupRegistrationButton_Click" runat="server" />  <%--<%# Translate("/conference/forms/common/next") %>--%>
            </div>
