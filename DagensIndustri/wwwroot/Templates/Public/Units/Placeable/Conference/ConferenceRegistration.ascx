    ...
    <div class="section" id="conference-registration">
            ...
            <div style="margin-top:10px; margin-left:20px;">
                ...
                <div style="width:180px;">
                    ...
                    <div style="float:right; padding-top:4px">
                        <img src="/Templates/Public/Images/forms/info-i.gif" title="Oavsett betalningssätt så ber vi om faktura uppgifter" />
                    </div>
                </div>
        ...
        <div class="button-wrapper">
            ...
            <div class="row-checkbox">
                <span class="checkbox" style="width:360px; float:left;">
                    <di:Input ID="TermsAcceptedInput" TypeOfInput="CheckBox" Required="true" Name="terms" Title="Jag godkänner <a href='http://dagensindustri.se/System/Footer/PUL-regler/' target='_blank'>deltagarvillkoren</a> och samtycker till däri beskriven personuppgiftsbehandling inom Bonnierkoncernen." DisplayMessage="Vänligen godkänn deltagarvillkoren" runat="server" />
                </span>
            </div>
        
            <div style="float:right;">
                <asp:Button ID="ConferenceRegistrationButton" Text='Skicka anmälan' CssClass="btn" OnClick="ConferenceRegistrationButton_Click" runat="server" /> <%--<%# Translate("/conference/forms/common/next") %>--%>
            </div>
