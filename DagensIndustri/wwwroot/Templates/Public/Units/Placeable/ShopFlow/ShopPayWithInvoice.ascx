<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ShopPayWithInvoice.ascx.cs" Inherits="DagensIndustri.Templates.Public.Units.Placeable.ShopFlow.ShopPayWithInvoice" %>
