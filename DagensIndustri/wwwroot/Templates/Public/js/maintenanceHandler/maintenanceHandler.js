var maintenanceHandler = {
    mySettingsPageTypeNames: [
        "[DI] MySet AddressPerm",
        "[DI] MySet AddressTemp",
        "[DI] MySet AddressTemp by Email",
        "[DI] MySet Autowithdrawal",
        "[DI] MySet CancelSubs",
        "[DI] MySet Complaint",
        "[DI] MySet GoldMembership",
        "[DI] MySet Invoice",
        "[DI] MySet LoginInfo",
        "[DI] MySet PersonInfo",
        "[DI] MySet Start",
        "[DI] MySet SubsSleeps",
        "[DI Common] PayInvoiceFlow",
        "[Di common] SsoLogin"
    ],
    campaignPageTypeNames: [
        "[DI] Campaign bootstrap", //http://dagens.dev/Prenumerera/di12/?id=562
        "[DI] Campaign", //http://dagens.dev/Campaigns/PAG299P/
        "[DI] Campaign Adr", //http://dagens.dev/Campaigns/DI-helg-149/adr/
        "[DI] Campaign C! prototyp"//http://dagens.dev/Kampanj/Pers-kampanj/
    ],
    textConstants: {
    ...
    handleMySettingsPages: function () {
        ...
        popup.css({ 'position': 'relative', 'top': '100px', 'min-height': '200px', 'margin':'30px auto', 'max-width': '500px', 'background-color': '#fff', 'display': 'block', 'z-index': '99999', 'box-shadow': '5px 5px 25px rgba(55, 55, 55, 0.5)', 'border-radius': '15px' });
