...
<div id="bottomSendBar" class="bottom-send-bar">
...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).bind('scroll', function() {
            var limitValue = 130;
            var d = $(document).height() - $(window).scrollTop() - $(window).height();
            if (d <= limitValue) {
                var setBottom = 135 - d;
                $('#bottomSendBar').attr('style', 'bottom: ' + setBottom + 'px !important;');
            } else {
                $('#bottomSendBar').removeAttr('style');
            }
