...
{
    //TODO: 2014-11-20 Remove? As this was last used 2011-12-20!!!
    public partial class DiGoldFreePlusSubs : DiTemplatePage
    {
        ...
        private bool CustHasAlreadyTakenDeal
        {
            get
            {
                var ds = SubscriptionController.GetSubscriptions(_cusno, false);
        ...
        private void TrySaveSubs()
        {
            ...
            bool okCirix = SubscriptionController.AddSubsIpadSummer(_cusno);
            if (!okCirix)
            {
                UserMessageControl.ShowMessage("/freeplussubs/contactus", true, true);
            }
