<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="Campaign.aspx.cs" Inherits="DagensIndustri.Templates.Public.Pages.bscampaign.Campaign" %>
<%@ Register TagPrefix="di" TagName="form" Src="~/Templates/Public/Pages/bscampaign/CampaignForm.ascx" %>
<%@ Register TagPrefix="di" TagName="header" Src="~/Templates/Public/Pages/bscampaign/CampaignHeader.ascx" %>
...
<%@ Register src="AddThisFieldset.ascx" tagname="AddThisFieldset" tagprefix="uc1" %>
...
<body data-pagetypename="<%=CurrentPage.PageTypeName %>">
