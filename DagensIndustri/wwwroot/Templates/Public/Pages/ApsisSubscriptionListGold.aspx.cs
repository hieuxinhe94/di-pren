...
namespace DagensIndustri.Templates.Public.Pages
{
    public partial class ApsisSubscriptionListGold : DiTemplatePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ButtonSubscribe.Visible = false;    //Do not do this in testmode as it will update real Apsis, and a cusno from test might affect a real customer with same cusno in Apsis production!
            }
            if (!IsPostBack)
            {
        ...
        protected void ButtonSubscribe_Click(object sender, EventArgs e)
        {
            ...
            if (MiscFunctions.ApsisMailerIsInTestMode) //Do not do this in testmode as it will update real Apsis, and a cusno from test might affect a real customer with same cusno in Apsis production!
            {
                return;
            }
