...
namespace DagensIndustri.Templates.Public.MasterPages
{
    public partial class MasterPage : System.Web.UI.MasterPage
    {
        ...
        protected override void OnInit(System.EventArgs e)
        {
            ...
            AddPageTypeNameDataAttributeOnBody();
        }
        ...
        protected void AddPageTypeNameDataAttributeOnBody()
        {
            var page = (EPiServer.PageBase)Page;
            Body.Attributes.Add("data-pagetypename", page.CurrentPage.PageTypeName);            
        }
