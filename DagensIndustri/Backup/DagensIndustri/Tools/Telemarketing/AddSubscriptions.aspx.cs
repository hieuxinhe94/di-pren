...
namespace DagensIndustri.Tools.Telemarketing
{
    ...
    public partial class AddSubscriptions : System.Web.UI.Page
    {
        ...
        private void SaveSubscription()
        {
            ...
            var subscriptionStartDate = CirixDbHandler.GetNextIssueDateIncDiRules(DateTime.Now, txtPaperCode.Value, txtProductNo.Value);
            ...
            var responseCode = BonDigHandler.TryAddCustAndSubToBonDig(txtPaperCode.Value, txtProductNo.Value, addCustSubRet.CirixSubscriberCusno, addCustSubRet.CirixSubsno, subscriber.Email, subscriber.FirstName, subscriber.LastName, string.Empty, password, addSubToExistingDiAccount);
        ...
        private IEnumerable<CampaignInfo> GetCampaigns()
        {
            ...
            {
                activeCampaigns.AddRange(CirixDbHandler.GetActiveFreeCampaigns(product.PaperCode, product.ProductNo));
            }
