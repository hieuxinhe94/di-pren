...
namespace DagensIndustri.Tools.Admin.DiGold
{
    ...
    public partial class DiGoldSearch : System.Web.UI.Page
    {
        ...
        private static bool IsActive(long cusno)
        {
            ...
            List<string> subsType = new List<string> { "01" };          
        ...
        public static bool IsDiWeekend(long cusno)
        {
            bool isDiWeekend = false;

            List<string> subsType = new List<string> { "05" };
            DataSet dsSubs = CirixDbHandler.Ws.GetSubscriptions_(cusno, "FALSE", "WEBCIRIX");
        ...
        public bool HasWineTicket(long cusno)
        {
