        ...
        <div id="MainBodyArea">
            ...
            <asp:Panel ID="Panel1" runat="server" DefaultButton="BtnShowPersons">
                ...
                <fieldset style="width:300px">
                    ...
                    <%--<asp:DropDownList runat="server" ID="DdlConferences" DataTextField="name" DataValueField="conferenceid"></asp:DropDownList>--%>
                ...
                <asp:PlaceHolder runat="server" ID="PhPdf" Visible="false">
                    ...
                    <asp:GridView 
                        ...
                        <Columns>    
                            ...
                            <asp:BoundField HeaderText="E-post" DataField="email" />
                            <asp:BoundField HeaderText="Telefon" DataField="phone" />                        
                            <asp:BoundField HeaderText="Datum" DataField="created" />                                               
                        </Columns>
                    </asp:GridView>
                </asp:PlaceHolder>
