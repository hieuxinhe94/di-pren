<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentAdmin.aspx.cs" Inherits="DagensIndustri.Tools.Admin.PayTrans.PaymentAdmin" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="MainBodyArea">
            ...
            <asp:ObjectDataSource runat="server" ID="GvDataSource" TypeName="DagensIndustri.Tools.Admin.PayTrans.PaymentAdmin" SelectMethod="GetResult">
                <SelectParameters>
