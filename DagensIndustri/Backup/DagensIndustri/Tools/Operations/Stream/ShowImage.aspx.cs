...
namespace DagensIndustri.Tools.Operations.Stream
{
    public partial class ShowImage : System.Web.UI.Page
    {
        ...
        private string GetCachedEttanGifpath(string pdfArchivePath)
        {
            ...
            string returnPath = pdfArchivePath + CirixDbHandler.GetIssueDate(paperCode, productNo, DateTime.Today, EnumIssue.Issue.InDateOrFirstBeforeInDate).ToString("yyyyMMdd") + ".gif";
