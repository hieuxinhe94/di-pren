                ...
                if (long.TryParse(customerNumber, out customerNo))
                {
                    ...
                    if (Subscriber.Cusno > 0)
                    {
                        ...
                        if (customerInvoices != null && customerInvoices.Tables[0].Rows.Count > 0)
                        {
                            ...
                            for (int i = customerInvoices.Tables[0].Rows.Count-1; i >= 0; i--)
                            {
                                DataRow dr = customerInvoices.Tables[0].Rows[i];
                                ...
                                if (result == "1")
                                    customerInvoices.Tables[0].Rows.RemoveAt(i);
                            }                           

                            int noOfHits = customerInvoices.Tables[0].Rows.Count;
                            if (noOfHits > 0)
                            {
