        ...
        public List<DateTime> WeekendIssueDatesInCloseRange
        {
            get
            {
                ...
                if (_weekendIssueDatesInCloseRange == null)
                    _weekendIssueDatesInCloseRange = CirixDbHandler.GetProductsIssueDatesInInterval(Settings.PaperCode_DI, Settings.ProductNo_Weekend, DateTime.Now.AddDays(-20), DateTime.Now.AddDays(1));
