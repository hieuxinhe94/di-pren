<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PostalPlace.ascx.cs" Inherits="DagensIndustri.Templates.Public.Units.Placeable.Subscription.PostalPlace" %>
