<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="CampaignPage.aspx.cs"
    Inherits="DagensIndustri.Templates.Public.Pages.C_Campaign.CampaignPage" MasterPageFile="~/Templates/Public/MasterPages/C-Campaign.Master" %>
                                    ...
                                    <div id="wform">
                                        ...
                                        <div class="form-group" id="address-extra">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-3 float-left">
                                                    <asp:Label runat="server" AssociatedControlID="TxtStairs">Trappa</asp:Label>
