<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="CampaignPaperSideBar.ascx.cs" Inherits="DagensIndustri.Templates.Public.Pages.bscampaign.CampaignPaperSideBar" %>
