<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="CampaignHeader.ascx.cs" Inherits="DagensIndustri.Templates.Public.Pages.bscampaign.CampaignHeader" %>
    ...
    function LoadPapers(campaign) {
        ...
        if ($("#PaperList").length) {
            ...
            $("#PaperList").delay(500).queue(function (nxt) {
                $(this).load("/Templates/Public/Pages/bscampaign/CampaignPaperList.aspx?c=" + campaign + "&id=" + pageId);
