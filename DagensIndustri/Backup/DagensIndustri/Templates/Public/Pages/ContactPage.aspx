...
<asp:Content ID="Content6" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
	...
	<ul class="contactlist"> 
		...
		<%--<li> 
		  	<div class="image-wrapper"><img width="140" height="210" src="/templates/public/images/placeholders/red-bf-small.jpg" class="attachment-large wp-post-image" alt="red-bf-small" title="red-bf-small" /></div> 
		  	<h2>Fredrik Björnsson</h2> 
		  	<p class="title">Redaktionschef</p> 
		  	<p class="phone">08-573 650 43</p> 
		  	<p class="mail"><a href="mailto:fredrik.bjornsson@di.se">fredrik.bjornsson@di.se</a></p> 
		</li> --%>
		  		
		<li> 
		  	<div class="image-wrapper"><img width="140" height="210" src="/templates/public/images/placeholders/red-kg-small.jpg" class="attachment-large wp-post-image" alt="red-kg-small" title="red-kg-small" /></div> 
		  	<h2>Klas Granström</h2> 
		  	<p class="title">Chef di.se</p> 
		  	<p class="phone">08-573 650 51</p> 
		  	<p class="mail"><a href="mailto:klas.granstrom@di.se">klas.granstrom@di.se</a></p> 
		</li> 
